...
export default definePlugin({
    name: "FakeVoice",
    description: "Appear muted or deafened to others while you can still hear and speak. Toggle from the user area (right-click for options) or with /fakemute and /fakedeafen.",
